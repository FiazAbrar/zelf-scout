...
def is_video_about_brand(title: str, channel: str, brand_name: str, description: str = "", category: str = "") -> bool:
    ...
    """
    # Fast reject: YouTube Music auto-generated pages are never brand content
    if description and ("auto-generated by youtube" in description.lower()
                        or "provided to youtube by" in description.lower()):
        return False
    ...
    prompt = (
        ...
        f'Channel: "{channel}"\n'
        f'{desc_line}\n'
        f'Is this video by a content creator (blogger, reviewer, influencer) primarily reviewing, '
        f'featuring, or discussing the CPG{category_line} brand "{brand_name}"?\n'
        f'Answer false if the video is music, entertainment, news, or unrelated to reviewing/discussing the brand as a product.\n'
